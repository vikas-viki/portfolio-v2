const Contact = () => {
    return (
        <section id="contact" className="w-full select-none flex flex-col items-center justify-center gap-4 p-8 mb-[400px] ">
            <span data-aos="fade-up" className="font-outfit text-[40px] font-bold text-center block text-white mb-[50px]">Get in Touch</span>
            <div className="main border border-slate-400 p-4 rounded-[5px] flex gap-[20px] flex-wrap md:flex-nowrap">
                <div className="photo  w-full md:w-[66%] rounded-[5px] flex items-center justify-center">
                    <img src="me.png" alt="me" className="hover:scale-[1.01] transition-all duration-150" />
                </div>
                <div className="contact  w-full h-full flex flex-col gap-4">
                    <div className="handles-me flex gap-4 w-full h-full">
                        <div className="border border-slate-400 p-4 rounded-[5px] flex gap-4 flex-wrap w-max justify-center items-center customShadow">
                        ...
                        <div className="text font-outfit border border-slate-400 p-4 rounded-[5px] customShadow">
