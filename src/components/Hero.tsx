    ...
    return (
        <section className='w-full rounded-lg text-white text-center flex justify-center items-center overflow-hidden'>
            ...
            <div className='flex flex-col items-center justify-center gap-2 z-[2] p-6'>
                <span className='tagline text-[70px] font-[600] leading-[1.2]  font-outfit '>Transforming challenges into <br /><span className="font-cursive font-[100] text-[100px] innovative ">innovative</span> solutions</span>
                <svg xmlns="http://www.w3.org/2000/svg" className="scale-x-[0.13] w-[300px] scale-y-[0.6] relative z-[-2] top-[-48px] left-[-150px] underline select-none" viewBox="0 0 1418 125">
                    <defs>
